...
export const TooltipRightStart = () => {
  ...
  return (
    <div style={{ backgroundColor: '#F3F6F8', padding: '20px', borderRadius: '10px', height: '50px' }}>
      <Parent onMouseOver={() => setHover(true)} onMouseOut={(e) => setHover(isMouseOutParent(e, 'parent0', 'right'))} id="parent0" aria-describedby="tooltip0" setHover={setHover} hover={hover}>
...
export const TooltipRight = () => {
  ...
  return (
    <div style={{ backgroundColor: '#F3F6F8', padding: '20px', borderRadius: '10px', height: '50px' }}>
      <Parent onMouseOver={() => setHover(true)} onMouseOut={(e) => setHover(isMouseOutParent(e, 'parent1', 'right'))} id="parent1" aria-describedby="tooltip1" setHover={setHover} hover={hover}>
        <ButtonIcon variant='mainButtonIcon' icon='icon-propiedades' holdPress active={active} badgeVariant='primary' onClick={() => setActive(active)}/>
      </Parent>
...
export const TooltipRightEnd = () => {
  ...
  return (
    <div style={{ backgroundColor: '#F3F6F8', padding: '20px', borderRadius: '10px', height: '50px' }}>
      <Parent onMouseOver={() => setHover(true)} onMouseOut={(e) => setHover(isMouseOutParent(e, 'parent2', 'right'))} id="parent2" aria-describedby="tooltip2" setHover={setHover} hover={hover}>
        <ButtonIcon variant='mainButtonIcon' icon='icon-propiedades' holdPress active={active} badgeVariant='primary' onClick={() => setActive(active)}/>
      </Parent>
...
export const TooltipBottomStart = () => {
  ...
  return (
    <div style={{ backgroundColor: '#F3F6F8', padding: '20px', paddingLeft: '100px', borderRadius: '10px', height: '50px' }}>
      <Parent onMouseOver={() => setHover(true)} onMouseOut={(e) => setHover(isMouseOutParent(e, 'parent3', 'bottom'))} id="parent3" aria-describedby="tooltip3" setHover={setHover} hover={hover} placement='bottom'>
        <ButtonIcon variant='mainButtonIcon' icon='icon-propiedades' holdPress active={active} badgeVariant='primary' onClick={() => setActive(active)}/>
      </Parent>
...
export const TooltipBottom = () => {
  ...
  return (
    <div style={{ backgroundColor: '#F3F6F8', padding: '20px', paddingLeft: '100px', borderRadius: '10px', height: '50px' }}>
      <Parent onMouseOver={() => setHover(true)} onMouseOut={(e) => setHover(isMouseOutParent(e, 'parent4', 'bottom'))} id="parent4" aria-describedby="tooltip4" setHover={setHover} hover={hover} placement='bottom'>
        <ButtonIcon variant='mainButtonIcon' icon='icon-propiedades' holdPress active={active} badgeVariant='primary' onClick={() => setActive(active)}/>
      </Parent>
...
export const TooltipBottomEnd = () => {
  ...
  return (
    <div style={{ backgroundColor: '#F3F6F8', padding: '20px', paddingLeft: '100px', borderRadius: '10px', height: '50px' }}>
      <Parent onMouseOver={() => setHover(true)} onMouseOut={(e) => setHover(isMouseOutParent(e, 'parent5', 'bottom'))} id="parent5" aria-describedby="tooltip5" setHover={setHover} hover={hover} placement='bottom'>
        <ButtonIcon variant='mainButtonIcon' icon='icon-propiedades' holdPress active={active} badgeVariant='primary' onClick={() => setActive(active)}/>
      </Parent>
...
export const TooltipLeftStart = () => {
  ...
  return (
    <div style={{ backgroundColor: '#F3F6F8', padding: '20px', paddingLeft: '200px', borderRadius: '10px', height: '50px' }}>
      <Parent onMouseOver={() => setHover(true)} onMouseOut={(e) => setHover(isMouseOutParent(e, 'parent6', 'left'))} id="parent6" aria-describedby="tooltip6" setHover={setHover} hover={hover} placement='left'>
        <ButtonIcon variant='mainButtonIcon' icon='icon-propiedades' holdPress active={active} badgeVariant='primary' onClick={() => setActive(active)}/>
      </Parent>
...
export const TooltipLeft = () => {
  ...
  return (
    <div style={{ backgroundColor: '#F3F6F8', padding: '20px', paddingLeft: '200px', borderRadius: '10px', height: '50px' }}>
      <Parent onMouseOver={() => setHover(true)} onMouseOut={(e) => setHover(isMouseOutParent(e, 'parent7', 'left'))} id="parent7" aria-describedby="tooltip7" setHover={setHover} hover={hover} placement='left'>
        <ButtonIcon variant='mainButtonIcon' icon='icon-propiedades' holdPress active={active} badgeVariant='primary' onClick={() => setActive(active)}/>
      </Parent>
...
export const TooltipLeftEnd = () => {
  ...
  return (
    <div style={{ backgroundColor: '#F3F6F8', padding: '20px', paddingLeft: '200px', borderRadius: '10px', height: '60px' }}>
      <Parent onMouseOver={() => setHover(true)} onMouseOut={(e) => setHover(isMouseOutParent(e, 'parent8', 'left'))} id="parent8" aria-describedby="tooltip8" setHover={setHover} hover={hover} placement='left'>
        <ButtonIcon variant='mainButtonIcon' icon='icon-propiedades' holdPress active={active} badgeVariant='primary' onClick={() => setActive(active)}/>
      </Parent>
...
export const TooltipTopStart = () => {
  ...
  return (
    <div style={{ backgroundColor: '#F3F6F8', paddingTop: '40px', paddingLeft: '200px', borderRadius: '10px', height: '60px' }}>
      <Parent onMouseOver={() => setHover(true)} onMouseOut={(e) => setHover(isMouseOutParent(e, 'parent9', 'top'))} id="parent9" aria-describedby="tooltip9" setHover={setHover} hover={hover} placement='top'>
        <ButtonIcon variant='mainButtonIcon' icon='icon-propiedades' holdPress active={active} badgeVariant='primary' onClick={() => setActive(active)}/>
      </Parent>
...
export const TooltipTop = () => {
  ...
  return (
    <div style={{ backgroundColor: '#F3F6F8', paddingTop: '40px', paddingLeft: '200px', borderRadius: '10px', height: '60px' }}>
      <Parent onMouseOver={() => setHover(true)} onMouseOut={(e) => setHover(isMouseOutParent(e, 'parent10', 'top'))} id="parent10" aria-describedby="tooltip10" setHover={setHover} hover={hover} placement='top'>
        <ButtonIcon variant='mainButtonIcon' icon='icon-propiedades' holdPress active={active} badgeVariant='primary' onClick={() => setActive(active)}/>
      </Parent>
...
export const TooltipTopEnd = () => {
  ...
  return (
    <div style={{ backgroundColor: '#F3F6F8', paddingTop: '40px', paddingLeft: '200px', borderRadius: '10px', height: '60px' }}>
      <Parent onMouseOver={() => setHover(true)} onMouseOut={(e) => setHover(isMouseOutParent(e, 'parent11', 'top'))} id="parent11" aria-describedby="tooltip11" setHover={setHover} hover={hover} placement='top'>
        <ButtonIcon variant='mainButtonIcon' icon='icon-propiedades' holdPress active={active} badgeVariant='primary' onClick={() => setActive(active)}/>
      </Parent>
