...
describe('InputNumber', () => {
  ...
  it('max number', () => {
    ...
    component.find('#inputNumberDisplay')
      .simulate('change', { target: { value: '5' } })
      .simulate('change', { stopPropagation: () => undefined, target: { value: '12' } })
  ...
  it('fn val', () => {
    ...
    component.find('#inputNumberDisplay').at(1)
  ...
  it('delete input', () => {
    ...
    component.find('#inputNumberDisplay')
      ...
      .props().onKeyDown({ key: 'Backspace', target: { value: '1' } })
  })
})
